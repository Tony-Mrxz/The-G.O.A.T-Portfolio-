...
const RoleCard = ({ title, role, desc, link, img }: { title: string, role: string, desc: string, link: string, img: string }) => (
    <div
        className="w-full p-3.5 md:p-4 rounded-xl bg-white/[0.04] backdrop-blur-xl border border-white/10 flex items-center gap-4 group transition-all duration-300 pointer-events-auto hover:bg-white/[0.07] hover:border-white/20"
    >
        <div className="w-16 h-16 md:w-20 md:h-20 rounded-xl overflow-hidden bg-white/5 border border-white/10 shrink-0">
        ...
        <div className="flex flex-col flex-1 min-w-0">
            <div className="flex items-center justify-between gap-4">
                <div className="flex flex-col truncate">
                    <h3 className="text-white font-semibold text-sm md:text-base tracking-wide truncate" style={{ fontFamily: "'Kanit', sans-serif" }}>{title}</h3>
                ...
                <a
                    ...
                    className="p-2 md:p-2.5 rounded-lg bg-white/5 border border-white/5 text-white/40 hover:bg-white hover:text-black hover:border-white transition-all duration-300 active:scale-95 flex-shrink-0"
                >
            ...
            {show && (
                ...
                >
                    <div className="relative flex flex-col md:flex-row items-center justify-center w-full min-h-screen mt-0 md:-mt-10 py-24 md:py-0">
                        ...
                        >
                            <div className={`relative pointer-events-auto flex flex-col ${isMobile ? 'h-auto' : (activeTab === 'intro' ? 'h-[320px]' : 'h-[460px]')} order-last md:order-first w-full`}>
                            ...
                            <motion.div
                                className={`mt-6 mb-8 md:mb-0 flex flex-col items-center gap-4 w-full pointer-events-auto order-first md:order-last ${activeTab === 'building' ? 'md:mt-20' : 'md:mt-52'}`}
